...
#             ttype = col2.selectbox("구분", constants.TYPES) # 상수 적용
#             category = col3.selectbox("카테고리", constants.CATEGORIES) # 상수 적용
